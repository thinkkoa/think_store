...
module.exports = class {
    constructor(options = {}) {
        ...
        //兼容旧版
        this.options.host = this.options.host || this.options.redis_host;
        this.options.port = this.options.port || this.options.redis_port;
        this.options.db = this.options.db || this.options.redis_db;
        this.options.password = this.options.password || this.options.redis_password;
        this.options.conn_timeout = this.options.conn_timeout || this.options.redis_timeout;
    ...
    decrby(name, decr) {
        decr = decr || 1;
        return this.handle.wrap('decrby', [this.options.key_prefix + name, decr]);
    }
