...
module.exports = class {
    constructor(options = {}) {
        options.conn_timeout && (options.conn_timeout = options.conn_timeout * 1000);
        this.options = {
            memcache_host: options.host || '127.0.0.1',
            memcache_port: options.port || 11211,
            memcache_poolsize: options.poolsize || 10, //memcache pool size
            memcache_timeout: options.conn_timeout || 5000, //try connection timeout
        };
        this.handle = null;
        this.deferred = null;
    }
    ...
    async wrap(name, data) {
        ...
        if (this.handle) {
            ...
            deferred.reject('memcache connection end');
        }
